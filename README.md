...
```
```
sudo git clone https://github.com/Samiul286/Phpnuxbill-FreeRADIUS.git
```
```
cd Phpnuxbill-FreeRADIUS
...
```
```
wget https://github.com/Samiul286/Phpnuxbill-FreeRADIUS/archive/refs/heads/main.zip
unzip *.zip
```
```
sudo mv Phpnuxbill-FreeRADIUS-main Phpnuxbill-FreeRADIUS
cd Phpnuxbill-FreeRADIUS
sudo chmod +x install.sh
sudo ./install.sh
```
